...
int main()
{
  ...
  cout << "Edge Connectivity: " << edgeConnectivity << " (Count: " << edgeConnectivityCount << ")" << endl;
  cout << "Vertex Connectivity: " << vertexConnectivity << " (Count: " << vertexConnectivityCount << ")" << endl;
